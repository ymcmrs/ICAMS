...
def main(argv):
    ...
    if not os.path.isfile(Mdlos):
        call_str = 'tropo_pyrite_sar.py ' + inps.geo_file + ' ' + inps.sar_par + ' --date ' + Mdate + ' --method ' + inps.method + ' --project ' + inps.project + ' --lalo-rescale ' + str(inps.lalo_rescale) + ' --kriging-points-numb ' + str(inps.kriging_points_numb)
        os.system(call_str)
    
    if not os.path.isfile(Sdlos):
        call_str = 'tropo_pyrite_sar.py ' + inps.geo_file + ' ' + inps.sar_par + ' --date ' + Sdate + ' --method ' + inps.method + ' --project ' + inps.project + ' --lalo-rescale ' + str(inps.lalo_rescale) + ' --kriging-points-numb ' + str(inps.kriging_points_numb)
        os.system(call_str)
