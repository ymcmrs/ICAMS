...
EXAMPLE = """Example:
  ...
  pyrite_timeseries.py --date-txt date_list --data tot_delay 
  pyrite_timeseries.py --date-txt date_list --data wet_delay --project zenith
  pyrite_timeseries.py --date-txt date_list --method linear --atm-dir /Yunmeng/SCRATCH/pyrite/ERA5/sar
  pyrite_timeseries.py --date-txt date_list --data dry_delay --project los
...
def main(argv):
    ...
    else: out_ts_era5 = 'timeseries_pyrite_' + inps.project + '_'+ inps.method + '.h5'
